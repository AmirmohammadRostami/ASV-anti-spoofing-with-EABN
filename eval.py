...
def main(pretrained, data_files, model_params, training_params, device, run_id):
    ...
    eval_data = SpoofDatsetSystemID(data_files['eval_scp'], data_files['eval_utt2index'], binary_class=False, is_eval = True)
    ...
    # evaluate_(score_file_pth, data_files['dev_asv'])
    ...
    evaluate_(score_file_pth, data_files['eval_asv'])
